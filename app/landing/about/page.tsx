  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 sm:py-12 lg:py-16">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16">
          ...
          <div className="flex-1 space-y-6 sm:space-y-8 lg:space-y-12">
            ...
            <div className="space-y-4 sm:space-y-6">
              <h1
                className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-teal-600 leading-tight"
                data-aos="fade-left"
              >
             Hello, I&#39;m
              ...
              <h2
                className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold text-teal-700 leading-tight"
                data-aos="fade-left"
                data-aos-delay="200"
              >
                EVAN CHIMWAZA
              ...
              <p
                className="text-base sm:text-lg md:text-xl lg:text-2xl text-teal-200 leading-relaxed max-w-2xl"
                data-aos="fade-left"
                data-aos-delay="400"
              >
              ...
              <p
                className="text-sm sm:text-base md:text-lg lg:text-xl text-teal-300 leading-relaxed max-w-2xl"
                data-aos="fade-left"
                data-aos-delay="600"
              >
            ...
            <div className="flex flex-col sm:flex-row gap-4 lg:gap-6">
              ...
              <a
                href="/path-to-cv.pdf"
                download
                className="bg-gradient-to-br from-teal-900/30 to-teal-700/20 backdrop-blur-sm border border-teal-500/20 rounded-xl p-4 sm:p-6 cursor-pointer group transition-all duration-300 hover:border-purple-400/40"
                data-aos="fade-up"
              >
                <div className="flex items-center space-x-4">
                  <div className="p-2 sm:p-3 bg-teal-500/20 rounded-lg group-hover:bg-teal-500/30 transition-all duration-300">
                    <Download className="w-5 h-5 sm:w-6 sm:h-6 text-teal-400" />
                  </div>
                  <div>
              ...
              <a
                href="/projects"
                className="bg-gradient-to-br from-teal-900/30 to-teal-700/20 backdrop-blur-sm border border-teal-500/20 rounded-xl p-4 sm:p-6 cursor-pointer group transition-all duration-300 hover:border-teal-400/40"
                data-aos="fade-up"
                data-aos-delay="200"
              >
                <div className="flex items-center space-x-4">
          ...
          <div className="flex-shrink-0" data-aos="fade-up">
            <div className="relative">
              <div className="w-48 h-48 sm:w-64 sm:h-64 lg:w-80 lg:h-80 rounded-full overflow-hidden border-4 border-teal-500/30 shadow-2xl shadow-purple-500/20">
                <Image
                  src="/evan.jpg"
        ...
        {/* Stats Cards Section */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mt-12 sm:mt-16 lg:mt-24">
          {/* Total Projects Card */}
          <div
            className="bg-gradient-to-br from-teal-900/30 to-teal-700/20 backdrop-blur-sm border border-teal-500/20 rounded-2xl p-6 sm:p-8 text-center group hover:border-teal-400/40 transition-all duration-300"
            data-aos="fade-right"
          >
